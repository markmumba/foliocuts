        ...
        <section id="features" className="py-32 bg-white relative">
            <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
                <div className="text-center mb-20">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-accent/5 border border-accent/20 mb-6">
                    ...
                    <h2 className="font-headings text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-6 max-w-3xl mx-auto leading-tight">
                        Everything your barbershop needs to thrive
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
                    ...
                    {/* Staff Management */}
                    <div className="bg-neutral/20 rounded-2xl p-8 border border-neutral/30">
                        <div className="w-12 h-12 bg-secondary/10 rounded-xl flex items-center justify-center mb-4">
                            <span className="text-2xl">👥</span>
                        </div>
                ...
                <div className="bg-primary rounded-2xl p-12 md:p-16 text-center">
                    ...
                    <a
                        ...
                        target="_blank"
                        className="inline-flex items-center px-8 py-4 bg-white text-primary font-semibold text-base rounded-lg hover:bg-neutral transition-colors"
                    >
                        <span>Start free trial</span>
                        <span className="ml-2">→</span>
                    </a>

                    <div className="flex items-center justify-center space-x-6 mt-8 pt-8 border-t border-white/10 text-sm text-white/60">
